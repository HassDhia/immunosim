...
\begin{enumerate}
    \item \textbf{CheckpointInhibitor-v0}: Anti-PD-1 monotherapy dosing using Kuznetsov-Taylor tumor-immune dynamics \citep{Kuznetsov1994} with Nikolopoulou PD-1 pharmacodynamics \citep{Nikolopoulou2018}.
...
\subsection{Kuznetsov-Taylor Tumor-Immune Model}

The base model \citep{Kuznetsov1994} describes effector cell ($E$) and tumor cell ($T$) dynamics:
\begin{align}
